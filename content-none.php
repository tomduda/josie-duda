...
<section class="<?php if (is_404()){
	...
	<div class="entry-content">
        ...
        <?php elseif ( is_404() ) : ?>
            <p><?php _e( 'The page you are looking for is not here. Why not try some of my blog posts below or click on the search item in the menu', 'josie' ); ?></p>
                <?php get_search_form(); ?>
    ...
    if ( is_404() || is_search() ) { ?>
        <header class="page-header">
            <h1 class="page-title"><?php _e( 'Most recent posts:', 'josie' ); ?></h1>
        </header>
    <?php
